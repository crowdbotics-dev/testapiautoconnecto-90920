...
## Project Structure
    ...
    ├── testapiautoconnecto_90920  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_90920`
...
2. Clone this repo and `cd testapiautoconnecto_90920`
